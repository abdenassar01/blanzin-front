import { Button, LatestOrderSlider } from '@/components';
        ...
        <div className='flex justify-between  sm:flex-col-reverse'>
          <div className='sm:full w-[69%]'>
            ...
            <article
              ...
              className='prose p-2 prose-h2:text-xl prose-h2:text-secondary prose-li:italic dark:prose-h2:text-main'
            ></article>
          ...
          <div className='sm:full w-[30%] rounded-xl bg-backgroundSecondary p-2 dark:bg-backgroundSecondaryDark'>
            ...
            <div className='border-[1px] border-main'>details</div>
            <div className='border-[1px] border-success'>customer-profile</div>
          </div>
        </div>
