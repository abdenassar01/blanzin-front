...
export function LanguageSlider() {
  const languages = [
    {
      label: 'German for Beginners 1.1',
      ...
      image: '/slider-images/German for Beginners 1.1.png',
    },
    {
      label: 'German for Beginners 1.2',
      secondaryLabel: 'German A1 20 Lessons approx. 1400 Exercises',
      description:
        'Increase your vocabulary and practice grammatical structures with part two of the beginners course.',
