...
const packs = [
  {
    ...
    offers: [
      ...
      {
        en: 'Video call counselling before the first interview-coaching',
        ar: 'ar- Video call counselling before the first interview-coaching',
        fr: 'fr- Video call counselling before the first interview-coaching',
        super: true,
        supported: false,
      },
    ],
