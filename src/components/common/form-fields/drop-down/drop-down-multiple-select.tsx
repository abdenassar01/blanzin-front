  ...
  return (
    <div
      ...
      <div
        ...
        className={cn(
          'no-scrollbar flex w-full items-center justify-between rounded-xl bg-backgroundSecondary text-xs text-[#A6A6A6] shadow-lg dark:bg-backgroundDark sm:text-mb-xxs',
          className,
