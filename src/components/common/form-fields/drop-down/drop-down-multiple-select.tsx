  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          'no-scrollbar flex w-full items-center justify-between rounded-xl border-[1px]  border-[#CFD6E7] bg-backgroundSecondary text-xs text-[#A6A6A6] dark:bg-backgroundSecondaryDark sm:text-mb-xxs',
          className,
