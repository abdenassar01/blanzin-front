    ...
    <div className={cn('group relative flex w-[100%] flex-col', className)}>
      ...
      <div className='my-3 flex flex-wrap items-center gap-2'>
        <Map
          items={items}
          render={(item, index) => (
            <div className='flex w-fit items-center justify-between gap-4 rounded-xl bg-border p-2 py-3'>
      ...
      <div className='flex gap-2'>
        <div className='relative w-[35%] sm:w-[45%]'>
          <div
            onClick={() => setLanguagesDropDown((prev) => !prev)}
            className='flex justify-between rounded-xl bg-background p-4 px-5 dark:bg-backgroundDark'
          >
          ...
          <div
            className={cn(
              'isolate z-50 mt-2 w-full cursor-pointer overflow-x-hidden rounded-xl bg-background shadow-md transition-all ease-out dark:bg-backgroundSecondaryDark dark:shadow-[#dadadb21] ',
